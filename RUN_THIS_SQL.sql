...
-- Go to: https://supabase.com/dashboard/project/ujcdbhxkdwzwkeajfljx/sql/new
...
-- Create indexes
create index if not exists voice_chat_history_user_id_idx on voice_chat_history(user_id);
create index if not exists voice_chat_history_created_at_idx on voice_chat_history(created_at desc);
